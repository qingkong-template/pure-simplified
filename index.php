...
<?php wp_head();?>
<link type="image/vnd.microsoft.icon" href="<?php bloginfo('template_url'); ?>/images/yan.jpg" rel="shortcut icon">
		...
		<?php if (is_single()||is_page()) { ?>
            ...
            <section class="ending">
                ...
                <ul>
                    ...
                    <li><img src="<?php echo get_option('biji_other_pay_wexpay');?>">支付宝</li>
                    <?php }; if(get_option('biji_other_pay_wexpay')){ ?>
                    <li><img src="<?php echo get_option('biji_other_pay_wexpay');?>">微信</li>
                    <?php };?>
                </ul>
                </div>
                <?php }?>
